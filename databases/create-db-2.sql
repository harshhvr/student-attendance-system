...
VALUES (
        'admin',
        'admin@email.com',
        '$2a$10$93zqAoqqT2qb/zYwNZBC1Oofq.T0A4oZ3x/DpgWBWIrMPngGyq2hu',
        'Admin',
        'Admin',
        'active'
    ),
...
VALUES (
        'TEACHER001',
        'teacher001@gmail.com',
        '$2a$10$xFkEcfTRKg6hQTLyZZWYMOklwiZKw8TsV2l6FEwlp8wyyeWlGrVPe',
        'Dr. Rohit',
        'Pathak'
    ),
    (
        'TEACHER002',
        'teacher002@gmail.com',
        '$2a$10$xFkEcfTRKg6hQTLyZZWYMOklwiZKw8TsV2l6FEwlp8wyyeWlGrVPe',
        'Er. Mrs. Nilema',
        'Karankar'
    ),
...
INSERT INTO SUBJECT (Subject_code, Subject_name, Status)
VALUES (
        'AIR4C1',
...
INSERT INTO SUBJECT (Subject_code, Subject_name, Status)
VALUES ('ITR4C2', 'Operating System', 'active');
INSERT INTO SUBJECT (Subject_code, Subject_name, Status)
VALUES ('ITR4C3', 'Software Engineering', 'active');
INSERT INTO SUBJECT (Subject_code, Subject_name, Status)
VALUES ('ITR4C4', 'Database Management System', 'active');
INSERT INTO SUBJECT (Subject_code, Subject_name, Status)
VALUES (
        'ITR4G2',
...
INSERT INTO SUBJECT (Subject_code, Subject_name, Status)
VALUES ('ITR4L2', 'Smart Systems Lab', 'active');
INSERT INTO SUBJECT (Subject_code, Subject_name, Status)
VALUES ('SIR4S4', 'Communication Skills', 'active');
...
UPDATE ADMIN
SET Status = 'blocked'
WHERE Aid IN ('ADMIN004', 'ADMIN005');
